    ...
    (() => {
        ...
        var __webpack_modules__ = [
                ...
                (t, e, s) => {
                    ...
                    e.stringToUTF16BEString = function stringToUTF16BEString(
                        t
                    ) {
                        const e = ['þÿ']
                        for (let s = 0, n = t.length; s < n; s++) {
                    ...
                    e.UnknownErrorException = class UnknownErrorException extends (
                        r
                    ) {
                        constructor(t, e) {
                    ...
                    e.InvalidPDFException = class InvalidPDFException extends (
                        r
                    ) {
                        constructor(t) {
                    ...
                    e.MissingPDFException = class MissingPDFException extends (
                        r
                    ) {
                        constructor(t) {
                ...
                (__unused_webpack_module, exports, __w_pdfjs_require__) => {
                    ...
                    function getDocument(t) {
                        ...
                        'boolean' != typeof n.useSystemFonts &&
                            (n.useSystemFonts =
                                !_is_node.isNodeJS && !n.disableFontFace)
                        ;('object' == typeof n.ownerDocument &&
                            null !== n.ownerDocument) ||
                        ...
                        r.promise
                            .then(function () {
                                ...
                                return Promise.all([t, s]).then(function ([
                                    t,
                                    s,
                                ]) {
                                    if (e.destroyed)
                    ...
                    class PDFPageProxy {
                        ...
                        render({
                            ...
                            if (
                                void 0 !== arguments[0]?.renderInteractiveForms
                            ) {
                                ;(0, _display_utils.deprecated)(
                            ...
                            if (
                                void 0 !==
                                arguments[0]?.includeAnnotationStorage
                            ) {
                                ;(0, _display_utils.deprecated)(
                            ...
                            const u = this._transport.getRenderingIntent(
                                s,
                                n,
                                d
                            )
                            this.pendingCleanup = !1
                            l ||
                                (l = this._transport.getOptionalContentConfig())
                        ...
                        getOperatorList({
                            ...
                            const n = this._transport.getRenderingIntent(
                                t,
                                e,
                                s,
                                !0
                                ...
                                i.operatorListChanged =
                                    function operatorListChanged() {
                                        if (r.operatorList.lastChunk) {
                                            r.opListReadCapability.resolve(
                                                r.operatorList
                                            )
                        ...
                        getStructTree() {
                            return (this._structTreePromise ||=
                                    ...
                                    (t) => {
                                        ...
                                        if (!this._transport.destroyed) {
                                            ...
                                            if (i.displayReadyCapability)
                                                i.displayReadyCapability.reject(
                                                    t
                                                )
                                            else {
                            ...
                            t.on('DocException', function (t) {
                                ...
                                switch (t.name) {
                                    ...
                                    case 'InvalidPDFException':
                                        s = new _util.InvalidPDFException(
                                            t.message
                                        )
                                        break
                                    case 'MissingPDFException':
                                        s = new _util.MissingPDFException(
                                            t.message
                                        )
                                        break
                    ...
                    class InternalRenderTask {
                        ...
                        cancel(t = null) {
                            ...
                            this._canvas &&
                                InternalRenderTask.#c.delete(this._canvas)
                            this.callback(
                                t ||
                    ...
                    class AnnotationStorage {
                        ...
                        get serializable() {
                            ...
                            for (const [e, s] of this._storage) {
                                const n =
                                    s instanceof i.AnnotationEditor
                                        ? s.serialize()
                                        : s
                                n && t.set(e, n)
                            }
                    ...
                    class AnnotationEditor {
                        ...
                        static deserialize(t, e) {
                            ...
                            const [n, i] = e.pageDimensions,
                                [r, a, o, l] = s.getRectInCurrentCoords(
                                    t.rect,
                                    i
                                )
                            s.x = r / n
                    ...
                    class AnnotationEditorUIManager {
                        ...
                        setEditingState(t) {
                            if (t) {
                                ...
                                this.#G({
                                    isEditing:
                                        this.#O !== n.AnnotationEditorType.NONE,
                                    isEmpty: this.#V(),
                                    hasSomethingToUndo:
                                        this.#k.hasSomethingToUndo(),
                                    hasSomethingToRedo:
                                        this.#k.hasSomethingToRedo(),
                                    hasSelectedEditor: !1,
                ...
                (t, e, s) => {
                    ...
                    class DOMCMapReaderFactory extends n.BaseCMapReaderFactory {
                        _fetchData(t, e) {
                            return fetchData(t, this.isCompressed).then(
                                (t) => ({ cMapData: t, compressionType: e })
                            )
                        }
                    }
                    ...
                    class PageViewport {
                        ...
                        convertToViewportRectangle(t) {
                            const e = i.Util.applyTransform(
                                    [t[0], t[1]],
                                    this.transform
                                ),
                                s = i.Util.applyTransform(
                                    [t[2], t[3]],
                                    this.transform
                                )
                ...
                (t, e, s) => {
                    ...
                    let i
                    e.FontLoader = i
                    e.FontLoader = i = class GenericFontLoader extends (
                        BaseFontLoader
                    ) {
                        constructor(t) {
                            super(t)
                        ...
                        _prepareFontLoadEvent(t, e, s) {
                            ...
                            function spliceString(t, e, s, n) {
                                return (
                                    t.substring(0, e) + n + t.substring(e + s)
                                )
                            }
                            let i, r
                            ...
                            const d = 1482184792
                            let u = int32(h, 16)
                            for (i = 0, r = c.length - 3; i < r; i += 4)
                                u = (u - d + int32(c, i)) | 0
                            i < c.length &&
                                (u = (u - d + int32(c + 'XXX', i)) | 0)
                ...
                (t, e, s) => {
                    ...
                    const l = 4096,
                        c =
                            o.isNodeJS && 'undefined' == typeof Path2D
                                ? -1
                                : 1e3,
                        h = 16
                    ...
                    class CanvasExtraState {
                        ...
                        getPathBoundingBox(t = r.PathType.FILL, e = null) {
                            ...
                            if (t === r.PathType.STROKE) {
                                ...
                                const t =
                                        i.Util.singularValueDecompose2dScale(e),
                    ...
                    function putBinaryImageData(t, e, s = null) {
                        ...
                        if (e.kind === i.ImageKind.GRAYSCALE_1BPP) {
                            const e = p.byteLength,
                                ...
                                A = (r + 7) >> 3
                            let _ = 4294967295,
                                y = i.FeatureTest.isLittleEndian
                                    ? 4278190080
                                    : 255
                            S &&
                                255 === S[0] &&
                    ...
                    class CanvasGraphics {
                        ...
                        executeOperatorList(t, e, s, n) {
                            ...
                            for (;;) {
                                ...
                                g = a[o]
                                if (g !== i.OPS.dependency)
                                    this[g].apply(this, r[o])
                                else
                                    for (const t of r[o]) {
                        ...
                        _createMaskCanvas(t) {
                            ...
                            const f = i.Util.applyTransform([0, 0], g),
                                ...
                                y = this.cachedCanvases.getCanvas(
                                    'fillCanvas',
                                    A,
                                    _
                                ),
                            ...
                            const E = i.Util.transform(
                                (0, n.getCurrentTransformInverse)(v),
                                [1, 0, 0, 1, -S, -x]
                            )
                            v.fillStyle = l
                                ? o.getPattern(e, this, E, r.PathType.FILL)
                                : o
                            v.fillRect(0, 0, s, a)
                            if (h && !l) {
                        ...
                        paintChar(t, e, s, r) {
                            const a = this.ctx,
                                ...
                                u = !!(
                                    c & i.TextRenderingMode.ADD_TO_PATH_FLAG
                                ),
                        ...
                        setStrokeRGBColor(t, e, s) {
                            const n =
                                this.selectColor?.(t, e, s) ||
                                i.Util.makeHexColor(t, e, s)
                            ...
                            if (Array.isArray(e) && 4 === e.length) {
                                ...
                                if (a && this.annotationCanvasMap) {
                                    ...
                                    const [a, l] =
                                        ...
                                        h = Math.ceil(
                                            r * this.outputScaleX * c
                                        ),
                                        d = Math.ceil(o * this.outputScaleY * c)
                                    this.annotationCanvas =
                                        this.canvasFactory.create(h, d)
                        ...
                        paintImageMaskXObject(t) {
                            ...
                            if (n) {
                                void 0 === n.compiled &&
                                    (n.compiled = (function compileType3Glyph(
                                        t
                                    ) {
                                        const { width: e, height: s } = t
                                        if (e > c || s > c) return null
                                        const n = new Uint8Array([
                                                0, 2, 4, 0, 1, 0, 5, 4, 8, 10,
                                                0, 8, 0, 2, 1, 0,
                                            ]),
                                            i = e + 1
                                        let r,
                        ...
                        paintInlineImageXObject(t) {
                            ...
                            const o = this._scaleImage(
                                a,
                                (0, n.getCurrentTransformInverse)(r)
                            )
                            ...
                            if (this.imageLayer) {
                                const [e, r] = i.Util.applyTransform(
                                    [0, -s],
                                    (0, n.getCurrentTransform)(this.ctx)
                                )
                            ...
                            if (!this._cachedGetSinglePixelWidth) {
                                ...
                                if (0 === t[1] && 0 === t[2])
                                    this._cachedGetSinglePixelWidth =
                                        1 /
                                        Math.min(Math.abs(t[0]), Math.abs(t[3]))
                                else {
                                    const e = Math.abs(
                                            t[0] * t[3] - t[2] * t[1]
                                        ),
                        ...
                        getPattern(t, e, s, r) {
                            ...
                            if (r === a.STROKE || r === a.FILL) {
                                ...
                                try {
                                    ...
                                    ;(0, n.warn)(
                                        `RadialAxialShadingPattern.getPattern: "${t?.message}".`
                                    )
                                }
                            } else {
                    ...
                    class MeshShadingPattern extends BaseShadingPattern {
                        ...
                        _createMeshCanvas(t, e, s) {
                            const n = Math.floor(this._bounds[0]),
                                ...
                                o = Math.min(
                                    Math.ceil(Math.abs(r * t[0] * 1.1)),
                                    3e3
                                ),
                                l = Math.min(
                                    Math.ceil(Math.abs(a * t[1] * 1.1)),
                                    3e3
                                ),
                                c = r / o,
                                h = a / l,
                    ...
                    class TilingPattern {
                        ...
                        createPatternCanvas(t) {
                            ...
                            const d = s[0],
                                ...
                                m = n.Util.singularValueDecompose2dScale(
                                    this.baseTransform
                                ),
                                b = [f[0] * m[0], f[1] * m[1]],
                        ...
                        getPattern(t, e, s, i) {
                            ...
                            if (i !== a.SHADING) {
                                ...
                                this.matrix &&
                                    (r = n.Util.transform(r, this.matrix))
                            }
                            ...
                            try {
                                ...
                                ;(0, n.warn)(
                                    `TilingPattern.getPattern: "${t?.message}".`
                                )
                            }
                            return c
                        }
                ...
                (t, e, s) => {
                    ...
                    e.applyMaskImageData = function applyMaskImageData({
                        ...
                        const l = n.FeatureTest.isLittleEndian
                                ? 4278190080
                                : 255,
                            [c, h] = o ? [0, l] : [l, 0],
                            d = r >> 3,
                            ...
                            switch (t.stream) {
                                ...
                                case a:
                                    ...
                                    new Promise(function (e) {
                                        e(
                                            f.onCancel &&
                                                f.onCancel(wrapReason(t.reason))
                                        )
                                    }).then(
                                        function () {
                                            r.postMessage({
                            ...
                            if (null !== t) {
                                ...
                                if ('OFF' === t.baseState)
                                    for (const t of this.#st.values())
                                        t._setVisible(i, !1)
                                for (const e of t.on)
                                    this.#st.get(e)._setVisible(i, !0)
                                for (const e of t.off)
                                    this.#st.get(e)._setVisible(i, !1)
                                this.#nt = new Map()
                                for (const [t, e] of this.#st)
                                    this.#nt.set(t, e.visible)
                            }
                        }
                        #rt(t) {
                            const e = t.length
                ...
                (t, e, s) => {
                    ...
                    e.PDFDataTransportStream = class PDFDataTransportStream {
                        ...
                        getRangeReader(t, e) {
                            ...
                            const s = new PDFDataTransportStreamRangeReader(
                                this,
                                t,
                                e
                            )
                ...
                (t, e, s) => {
                    ...
                    class AnnotationEditorLayer {
                        ...
                        destroy() {
                            this.#pt.getActive()?.parent === this &&
                                this.#pt.setActiveEditor(null)
                            for (const t of this.#ht.values()) {
                                this.#at?.removePointerInTextLayer(t.contentDiv)
                                t.isAttachedToDOM = !1
                                t.div.remove()
                        ...
                        render(t) {
                            ...
                            this.setDimensions()
                            for (const t of this.#pt.getEditors(this.pageIndex))
                                this.add(t)
                            this.updateMode()
                        }
                        update(t) {
                    ...
                    class FreeTextEditor extends r.AnnotationEditor {
                        ...
                        static updateDefaultParams(t, e) {
                            switch (t) {
                                case n.AnnotationEditorParamsType.FREETEXT_SIZE:
                                    ...
                                    break
                                case n.AnnotationEditorParamsType
                                    .FREETEXT_COLOR:
                        ...
                        #Ct(t) {
                            ...
                            this.parent.addCommands({
                                ...
                                mustExec: !0,
                                type: n.AnnotationEditorParamsType
                                    .FREETEXT_SIZE,
                        ...
                        getInitialTranslation() {
                            return [
                                -FreeTextEditor._internalPadding *
                                    this.parent.scaleFactor,
                                -(FreeTextEditor._internalPadding + this.#Et) *
                                    this.parent.scaleFactor,
                            ]
                        }
                        rebuild() {
                        ...
                        enableEditMode() {
                            if (!this.isInEditMode()) {
                                ...
                                this.parent.updateToolbar(
                                    n.AnnotationEditorType.FREETEXT
                                )
                    ...
                    class InkEditor extends i.AnnotationEditor {
                        ...
                        #te(t, e) {
                            ...
                            if (1 !== this.currentPath.length)
                                i = (0, r.fitCurve)(this.currentPath, 30, null)
                            else {
                                const s = [t, e]
                        ...
                        #he() {
                            ...
                            for (const r of this.paths)
                                for (const [a, o, l, c] of r) {
                                    const r = n.Util.bezierBoundingBox(
                                        ...a,
                                        ...o,
                                        ...l,
                                        ...c
                ...
                (t) => {
                    function fitCubic(t, e, s, n, i) {
                        ...
                        a = (function chordLengthParameterize(t) {
                            ...
                            t.forEach((t, r) => {
                                e = r
                                    ? s + maths.vectorLen(maths.subtract(t, n))
                                    : 0
                                i.push(e)
                                s = e
                                n = t
                        ...
                        f = []
                        if (
                            (u = maths.subtract(t[h - 1], t[h + 1])).every(
                                (t) => 0 === t
                            )
                        ) {
                    ...
                    function generateAndReport(t, e, s, n, i, r) {
                        ...
                        a = (function generateBezier(t, e, s, n) {
                            ...
                            if (u < (g = 1e-6 * f) || p < g) {
                                i[1] = maths.addArrays(
                                    v,
                                    maths.mulItems(s, f / 3)
                                )
                                i[2] = maths.addArrays(
                                    S,
                                    maths.mulItems(n, f / 3)
                                )
                            } else {
                    ...
                    class bezier {
                        ...
                        static qprime(t, e) {
                            var s = 1 - e,
                                n = maths.mulItems(
                                    maths.subtract(t[1], t[0]),
                                    3 * s * s
                                ),
                                i = maths.mulItems(
                                    maths.subtract(t[2], t[1]),
                                    6 * s * e
                                ),
                                r = maths.mulItems(
                                    maths.subtract(t[3], t[2]),
                                    3 * e * e
                                )
                ...
                (t, e, s) => {
                    ...
                    class AnnotationElement {
                        ...
                        get _commonActions() {
                            const setColor = (t, e, s) => {
                                const n = s.detail[t]
                                s.target.style[e] = a.ColorConverters[
                                    `${n[0]}_HTML`
                                ](n.slice(1))
                            }
                            return (0, n.shadow)(this, '_commonActions', {
                                ...
                                hidden: (t) => {
                                    this.container.style.visibility = t.detail
                                        .hidden
                                        ? 'hidden'
                                        : 'visible'
                                    this.annotationStorage.setValue(
                    ...
                    class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                        ...
                        render() {
                            ...
                            if (this.renderForms) {
                                ...
                                blurListener &&
                                    s.addEventListener('blur', blurListener)
                                if (this.data.comb) {
                                    const t =
                                        (this.data.rect[2] -
                                            this.data.rect[0]) /
                                ...
                                i.addEventListener('updatefromsandbox', (e) => {
                                    const i = {
                                        value: (e) => {
                                            ...
                                            for (const n of this._getElementsByName(
                                                e.target.name
                                            )) {
                                                const e = i && n.id === s
                                                n.domElement &&
                                                    (n.domElement.checked = e)
                    ...
                    class AnnotationLayer {
                        ...
                        static render(t) {
                            ...
                            for (const c of e) {
                                if (
                                    c.annotationType !== n.AnnotationType.POPUP
                                ) {
                                    const { width: t, height: e } = getRectDims(
                                        c.rect
                                    )
                                    if (t <= 0 || e <= 0) continue
                                }
                ...
                (t, e, s) => {
                    ...
                    e.XfaLayer = class XfaLayer {
                        ...
                        static setAttributes({
                            ...
                            s &&
                                r.dataId &&
                                this.setupStorage(t, r.dataId, e, s)
                        }
                        static render(t) {
                ...
                (t, e, s) => {
                    ...
                    function appendText(t, e, s, i) {
                        ...
                        t._fontInspectorEnabled &&
                            (l.dataset.fontName = e.fontName)
                        0 !== d && (c.angle = d * (180 / Math.PI))
                        let b = !1
                        if (
                            e.str.length > 1 ||
                            (t._enhanceTextSelection && o.test(e.str))
                        )
                            b = !0
                        else if (
                            ' ' !== e.str &&
                        ...
                        if (t._enhanceTextSelection && c.hasText) {
                            ...
                            if (0 !== d) {
                                o = [s, i, -i, s, f, m]
                                c = n.Util.getAxialAlignedBoundingBox(
                                    [0, 0, r, a],
                                    o
                                )
                            } else c = [f, m, f + r, m + a]
                    ...
                    function expandBoundsLTR(t, e) {
                        ...
                        for (const t of e) {
                            ...
                            for (a = e; a <= r; a++) {
                                ...
                                for (
                                    o = e - 1;
                                    !t && o >= 0 && s[o].start >= i.y1;
                                    o--
                                )
                                    t = s[o].boundary === i
                                for (
                                    o = r + 1;
                                    !t && o < s.length && s[o].end <= i.y2;
                                    o++
                                )
                                    t = s[o].boundary === i
                                for (o = 0; !t && o < c.length; o++)
                                    t = c[o].boundary === i
                                t || (i.x2New = l)
                            }
                    ...
                    class TextLayerRenderTask {
                        ...
                        expandTextDivs(t = !1) {
                            ...
                            const e = [],
                                s = []
                            for (
                                let n = 0, i = this._textDivs.length;
                                n < i;
                                n++
                            ) {
                                ...
                                if (r.hasText)
                                    if (t) {
                                        ...
                                        r.paddingRight > 0
                                            ...
                                            : s.push(0)
                                        r.paddingBottom > 0
                                            ? s.push(`${r.paddingBottom}px`)
                                            : s.push(0)
                                        if (r.paddingLeft > 0) {
                                            s.push(
                                                r.paddingLeft / r.scale + 'px'
                                            )
                                            e.push(
                                                `translateX(${-r.paddingLeft / r.scale}px)`
                                            )
                                        } else s.push(0)
                                        i.style.padding = s.join(' ')
                                        e.length &&
                                            (i.style.transform = e.join(' '))
                                    } else {
                ...
                (t, e, s) => {
                    ...
                    e.SVGGraphics = a
                    {
                        ...
                        e.SVGGraphics = a = class {
                            ...
                            setStrokeRGBColor(t, e, s) {
                                this.current.strokeColor = i.Util.makeHexColor(
                                    t,
                                    e,
                                    s
                                )
                            ...
                            setFillRGBColor(t, e, s) {
                                this.current.fillColor = i.Util.makeHexColor(
                                    t,
                                    e,
                                    s
                                )
                            ...
                            paintFormXObjectEnd() {}
                            _initialize(t) {
                                const e = this.svgFactory.create(
                                        t.width,
                                        t.height
                                    ),
                                    s =
                ...
                (t, e, s) => {
                    ...
                    class PDFNodeStreamFsRangeReader extends BaseRangeReader {
                        constructor(t, e, s) {
                            ...
                            this._setReadableStream(
                                r.createReadStream(n, { start: e, end: s - 1 })
                            )
                        }
                    }
                },
                    ...
                    class PDFFetchStreamReader {
                        constructor(t) {
                            ...
                            fetch(
                                ...
                                .then((t) => {
                                    if (
                                        !(0, i.validateResponseStatus)(t.status)
                                    )
                                        throw (0, i.createResponseStatusError)(
                                            t.status,
                                            s
                                        )
                                    ...
                                    this._contentLength =
                                        r || this._contentLength
                                    this._filename = (0,
                                    i.extractFilenameFromHeader)(
                                        getResponseHeader
                                    )
                                    !this._isStreamingSupported &&
                                        this._isRangeSupported &&
