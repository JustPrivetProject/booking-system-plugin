...
describe('RequestHandler', () => {
    ...
    describe('setupRequestListeners', () => {
        ...
        it('should setup beforeSendHeaders listener with correct parameters', () => {
            ...
            const call = (chrome.webRequest.onBeforeSendHeaders.addListener as jest.Mock).mock.calls[0]
            expect(call[1]).toEqual({ urls: ['*://*/TVApp/EditTvAppSubmit/*'] })
    ...
    describe('cacheRequestBody', () => {
        ...
        it('should handle storage errors gracefully', async () => {
            ...
            expect(consoleLog).toHaveBeenCalledWith('Error caching request body:', expect.any(Error))
        })
    ...
    describe('handleRequestHeaders', () => {
        ...
        it('should handle storage errors gracefully', async () => {
            ...
            expect(consoleLog).toHaveBeenCalledWith('Error caching request headers:', expect.any(Error))
        })
    })
    ...
    describe('removeCachedBody', () => {
        ...
        it('should handle storage errors gracefully', async () => {
            ...
            expect(consoleLog).toHaveBeenCalledWith('Error removing cached body:', expect.any(Error))
        })
    })
